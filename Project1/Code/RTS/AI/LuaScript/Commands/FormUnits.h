// $Id: //depot/Projects/StarWars_Steam/FOC/Code/RTS/AI/LuaScript/Commands/FormUnits.h#1 $
///////////////////////////////////////////////////////////////////////////////////////////////////
//
...
///////////////////////////////////////////////////////////////////////////////////////////////////
//
//              $File: //depot/Projects/StarWars_Steam/FOC/Code/RTS/AI/LuaScript/Commands/FormUnits.h $
//
...
#ifndef __FORMUNITS_H__
#define __FORMUNITS_H__
...
struct FleetMergeResult : public SignalDataClass
{
	PG_DECLARE_RTTI();
	int		ObjectID;
};

class FormationBlockStatus : public BlockingStatus, public SignalListenerClass
{
public:
	PG_DECLARE_RTTI();
	LUA_DECLARE_FACTORY(LUA_CHUNK_FORMATION_BLOCK, FormationBlockStatus);

	FormationBlockStatus();
	void Init(LuaUserVar *command, GameObjectWrapper *fleet);
	void Add_Merge_Object(GameObjectClass *obj);
